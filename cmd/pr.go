...
var prCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		url := project + "/_git/" + repository.Name + "/pullrequestcreate?sourceRef=" + branchName + "&targetRef=main&sourceRepositoryId=" + repository.Id + "&targetRepositoryId=" + repository.Id
